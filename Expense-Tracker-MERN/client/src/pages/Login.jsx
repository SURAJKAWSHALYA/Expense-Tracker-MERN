    ...
    >
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <motion.div variants={itemVariants} className="flex-1">
            <button type="button" className="w-full flex items-center justify-center gap-2 rounded-xl border border-slate-300 dark:border-white/10 bg-white dark:bg-slate-900/50 px-4 py-3 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors shadow-sm">
          ...
          <motion.div variants={itemVariants} className="flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between mt-1 text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input 
                  type="checkbox" 
                  className="rounded border-indigo-200 dark:border-white/20 bg-slate-50 dark:bg-slate-900/50 text-indigo-600 dark:text-yellow-400 focus:ring-indigo-600/20 dark:focus:ring-yellow-400/20"
                />
        ...
        <motion.p variants={itemVariants} className="mt-2 text-center text-sm text-slate-700 dark:text-slate-400 transition-colors">

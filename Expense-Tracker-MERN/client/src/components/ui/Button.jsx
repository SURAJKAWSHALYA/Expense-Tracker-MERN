...
export default function Button({ 
  ...
  const variants = {
    ...
    // Ghost
    ghost: 'text-slate-700 hover:text-slate-900 hover:bg-slate-100 dark:text-slate-300 dark:hover:text-white dark:hover:bg-white/10 disabled:text-slate-400 disabled:hover:bg-transparent dark:disabled:text-slate-600 dark:disabled:hover:bg-transparent',
  };
